...
export const skills = {
  languages: ["C/C++", "Python", "Java", "JavaScript", "Node.js", "React.js", "PHP", "SQL", "MySQL", "HTML", "CSS"],
  web: ["Full-Stack Development", "Frontend and Backend", "Android Development"],
  tools: ["Git", "Visual Studio", "OpenCV", "Pandas", "NumPy", "XAMPP", "Google Cloud", "Arduino IDE"],
  ai: ["Deep Learning", "Natural Language Processing (NLP)", "Computer Vision"],
};
...
export const experiences = [
  ...
  },
  {
    ...
    location: "Bangalore, India",
    duration: "02 January 2023 – 28 April 2023",
    points: [
  ...
  },
  {
    ...
    role: "Project Contributor – PostgreSQL",
...
export const projects = [
    {
        name: "Farmer Crop Insurance claim By (PMFBY)",
    ...
    {
        name: "MMDU UMS APP (University Project)",
    ...
    {
        name: "Keep Tab: A novel way to aid memory with deep learning algorithms",
        tech: "",
        duration: "2019 - 2021",
        points: [
...
export const certifications = [
    {
        ...
        issuer: "ISRO – Remote, India",
        date: "April 2024 – May 2024"
    },
    {
        name: "Silver League – Image captioning models and mastering diverse topics including generative AI, responsible AI, and large language models.",
        issuer: "Google Cloud – Remote, India",
        date: "2 March, 2024"
    },
    {
        name: "Advanced React.js",
        issuer: "Cutshort – Remote, India",
        date: "17 Sep, 2023"
    },
    {
        name: "FPGA-Based Embedded Systems (SMDP-III Project)",
        issuer: "NIELIT Calicut – Remote, India",
