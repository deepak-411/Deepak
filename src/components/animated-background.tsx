...
export function AnimatedBackground() {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full -z-10 overflow-hidden bg-background">
      <div className="absolute inset-0 z-0 opacity-40 bg-[radial-gradient(ellipse_50%_50%_at_50%_50%,_hsl(var(--primary)/0.2),_transparent_70%)] animate-pulse-slow"></div>
      <div className="absolute inset-0 z-0 opacity-40 bg-[radial-gradient(ellipse_80%_80%_at_50%_90%,_hsl(var(--accent)/0.2),_transparent_70%)] animate-pulse-slow animation-delay-[-4s]"></div>
